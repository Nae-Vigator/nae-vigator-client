...
function Login() {
  return (
    <div className="min-h-screen bg-[#1D1B2B] flex items-center justify-center">
      <div className="w-full max-w-[400px] px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-zinc-300 text-3xl font-semibold tracking-tight">
            로그인 하고 서비스를 이용해보세요!
          </p>
        </div>

        <div className="space-y-3">
          <button className="w-full h-12 bg-[#03C75A] hover:bg-[#02b350] text-white font-medium rounded-lg transition-colors flex items-center justify-center gap-2">
            <img src={naver} alt="네이버" className="w-5 h-5" />
            네이버로 로그인
          </button>
          ...
          <button className="w-full h-12 bg-[#FEE500] hover:bg-[#fdd800] text-[#191919] font-medium rounded-lg transition-colors flex items-center justify-center gap-2">
            <img src={kakao} alt="카카오" className="w-5 h-5" />
            카카오톡으로 로그인
          </button>
