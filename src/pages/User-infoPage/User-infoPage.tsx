  ...
  return (
    <div className="w-full">
      ...
      <div ref={personalInfoRef} className="mb-12">
        <h2 className="typo-h4 text-foreground mb-6">인적사항</h2>
          ...
          <div className="flex gap-6">
            ...
            <div className="flex-1">
              <div className="grid grid-cols-4 gap-4 mb-4">
                <div>
                  <Label htmlFor="name" isRequired className="text-sm mb-2 block">
                    이름
                  </Label>
                  <Input id="name" placeholder="홍길동" className="bg-white" />
                </div>
                <div>
                  <Label htmlFor="birthdate" isRequired className="text-sm mb-2 block">
                    생년월일
                  </Label>
                  <Input id="birthdate" placeholder="0000.00.00" className="bg-white" />
                </div>
                <div>
                  <Label htmlFor="gender" isRequired className="text-sm mb-2 block">
                    성별
                  </Label>
                  <select
                    id="gender"
                    className="flex h-9 w-full rounded-md border border-input bg-white px-3 py-2 text-sm text-zinc-400"
                  >
                ...
                <div>
                  <Label htmlFor="email" isRequired className="text-sm mb-2 block">
                    이메일
                  </Label>
                  <Input id="email" type="email" placeholder="ava.wright@gmail.com" className="bg-white" />
                </div>
              </div>

              <div className="grid grid-cols-2 gap-4 mb-6">
                <div>
                  <Label htmlFor="phone" isRequired className="text-sm mb-2 block">
                    휴대전화번호
                  </Label>
                  <Input id="phone" placeholder="010-0000-0000" className="bg-white" />
                </div>
                <div>
                  ...
                  <div className="flex gap-2">
                    <Input id="address" placeholder="주소지 검색" className="flex-1 bg-white" />
              ...
              <div className="flex flex-wrap gap-4">
                <label className="flex items-center gap-2 cursor-pointer">
                  ...
                  <span className="text-sm">보훈대상</span>
                </label>
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" className="w-4 h-4 rounded border-gray-300" />
                ...
                <label className="flex items-center gap-2 cursor-pointer">
                  <input type="checkbox" className="w-4 h-4 rounded border-gray-300" />
                  <span className="text-sm">병역</span>
                </label>
              </div>
            </div>
          </div>
      ...
      <div ref={skillsRef} className="mb-12">
        <div className="flex items-center justify-between mb-6">
          <h2 className="typo-h4 text-foreground">스킬</h2>
        </div>
      ...
      <div ref={educationRef} className="mb-12">
        <div className="flex items-center justify-between mb-6">
          <h2 className="typo-h4 text-foreground">학력 및 학점</h2>
          <Button variant="outline" size="sm">
            + 추가하기
          </Button>
        </div>
        <div className="bg-zinc-50 p-6 rounded-lg min-h-[100px] border border-gray-200">
          {/* Content will be added when user clicks 추가하기 */}
        </div>
      </div>

      <div ref={experienceRef} className="mb-12">
        <div className="flex items-center justify-between mb-6">
          <h2 className="typo-h4 text-foreground">경력</h2>
          <Button variant="outline" size="sm">
            + 추가하기
          </Button>
        </div>
      ...
      <div ref={activitiesRef} className="mb-12">
        <div className="flex items-center justify-between mb-6">
          <h2 className="typo-h4 text-foreground">대외활동</h2>
          <Button variant="outline" size="sm">
            + 추가하기
          </Button>
        </div>
      ...
      <div ref={trainingRef} className="mb-12">
        <div className="flex items-center justify-between mb-6">
          <h2 className="typo-h4 text-foreground">교육</h2>
          <Button variant="outline" size="sm">
            + 추가하기
          </Button>
        </div>
      ...
      <div ref={certificatesRef} className="mb-12">
        <div className="flex items-center justify-between mb-6">
          <h2 className="typo-h4 text-foreground">자격증 및 어학</h2>
          <Button variant="outline" size="sm">
            + 추가하기
          </Button>
        </div>
      ...
      <div ref={awardsRef} className="mb-12">
        <div className="flex items-center justify-between mb-6">
          <h2 className="typo-h4 text-foreground">수상</h2>
          <Button variant="outline" size="sm">
            + 추가하기
          </Button>
        </div>
      ...
      <div ref={abroadRef} className="mb-12">
        <div className="flex items-center justify-between mb-6">
          <h2 className="typo-h4 text-foreground">해외경험</h2>
          <Button variant="outline" size="sm">
            + 추가하기
          </Button>
        </div>
